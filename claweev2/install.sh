...
#
# This is the stable, curl'd-alone entry point for the `claweev2` component. It
...
#
# DO NOT EDIT generated copies (claweev2/install.sh) by hand — they are produced
# from tools/bootstrap.template.sh by tools/gen-bootstraps.sh.
#
# Env vars:
#   CLAWEE_<COMP>_VERSION   pin a release tag (e.g. claweev2/v0.1.1.…); default: latest
